 ...
 * @author Admin
 */
public class VentanaParticipaciones extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VentanaParticipaciones.class.getName());
     ...
     */
    public VentanaParticipaciones(Gestion gestion, Pantalla pantallaAnterior) {
        initComponents();
